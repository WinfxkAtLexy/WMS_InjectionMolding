 ...
 * 调拨请求
 */
class Transfer private constructor(private val title: JSONObject, private val json: JSONObject, private val array: JSONArray) {
    init {
        log.i("正在初始化数据...")
    }
    /**
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun sendMessage(title: JSONObject, json: JSONObject, array: JSONArray) = Transfer(title, json, array).start();
    }
    /**
     * 请求头
     * {
